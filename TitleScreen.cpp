...
void TitleScreen::initialise()
{
    ...
    m_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, TitleScreen_DATA, map_texture_id, 1.0f, 4, 1);
...
{
    Utility::draw_text(program, m_state.title_screen_text->m_texture_id, "Thanato", 0.5f, 0.1f, glm::vec3(3.0f, -1.0f, 0.0f));
    Utility::draw_text(program, m_state.title_screen_text->m_texture_id, "Press Enter...", 0.5f, 0.1f, glm::vec3(2.0f, -2.0f, 0.0f));
